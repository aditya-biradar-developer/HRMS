...
exports.getAdminDashboard = async (req, res) => {
  try {
    ...
    // Get total employees (exclude admin, candidate users, and employees who haven't started yet)
    ...
    // Get department distribution (exclude admin and candidate users)
    ...
    // Get active employees (exclude admin and candidate users)
    ...
    // Get new hires this month (exclude admin and candidate users)
