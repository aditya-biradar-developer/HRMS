  ...
  try {
    ...
    if (dayOfWeek !== 0 && dayOfWeek !== 6) {
      if (['admin', 'hr', 'manager'].includes(userRole)) {
        ...
        console.log(`📊 Attendance notification: ${allUsers?.length || 0} active employees, ${markedUsers.size} marked, ${unmarkedUsers.length} unmarked`);
      } else {
    ...
    if (['admin', 'hr'].includes(userRole)) {
      ...
      console.log('📊 Applications notification count:', {
        userRole,
        pendingCount: counts.applications,
