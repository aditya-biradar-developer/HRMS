...
async function autoMarkAbsent() {
  try {
    ...
    // Get all active employees (not candidates, and who have started working)
    ...
    console.log(`👥 Found ${allUsers.length} users to check (excluding admin, candidates, and employees who haven't started yet)`);
